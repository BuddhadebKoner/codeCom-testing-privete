   ...
   return (
      ...
      >
         ...
         <div className="absolute inset-0 flex flex-col justify-end p-4 text-white">
            <h2 className="text-xl font-bold mb-2 group-hover:scale-105 transition-transform duration-300">
               {event.title}
            </h2>
            <p className="text-sm mb-2 group-hover:scale-105 transition-transform duration-300">
               {event.subtitle}
            </p>
